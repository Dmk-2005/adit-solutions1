  ...
  return (
    <div id='hero' className='flex flex-col items-center gap-6 pt-56 pb-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
      ...
      <motion.p
        ...
        className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>We help businesses grow online through smart, data-driven strategies that deliver real results. We combine creativity with analytics to turn ideas into performance.</motion.p>
